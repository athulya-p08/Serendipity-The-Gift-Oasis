    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/couple gift.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>WATCH & BRACELET</h4></span>
          <h1>Black-Gold Combo Gift Set</h1>
          <div class="price">Rs.899</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Black-Gold Combo Gift Set',899,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Black-Gold Combo Gift Set',899)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>WATCH & BRACELET</h2> 
            <br>
            <h4> Keep time and love in sync with our exquisite couple watch.<br> This timepiece is the perfect symbol for your eternal bond. It shows timeless flow of love.</p>
            <br><br>
        Strap material:Stainless Steel,Leather <br> Material:Stainless Steel <br> Suitable for:Anniversary,wedding,valentines day <br> Speciality:Comfort fit design,Water-resistant,Modern</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple_gift1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple Watch</span>
            <a href="">Trendy white-themed couple watch</a>
            <h4>Rs.3499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple_gift2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Couple Watch</span>
            <a href="">Black-Gold couple watch</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple_gift3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple Watch</span>
            <a href="">Rose-Gold themed watch</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple_gift4.jpeg" alt="" />
            </a>
          
          </div>
          <div class="product-info">
            <span>Couple Watch</span>
            <a href="">White-Gold couple watch</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/couple gift.jpeg"; // Replace this with the actual image path or dynamically fetch it
