    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/baby hamper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Baby's Hamper</h4></span>
          <h1>Johnson's Baby Hamper</h1>
          <div class="price">Rs.1999</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Johnsons Baby Hamper',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Johnsons Baby Hamper',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Baby's Hamper</h2> 
            <br>
            <h4>Welcome your little bundle of joy with love and care. This adorable hamper is filled with essentials for baby's first few months. Soft toys,cozy blankets and adorable ones await. Perfect for new parents,baby showers or as a thoughtful gift. A thoughtful way to celebrate the arrival of your little one.</p>
            <br><br>
        Hamper Size:Medium <br> Suitable for:Baby shower,Birthday <br> Products included:Soft towel,baby powder,baby shampoo,baby soap,cotton buds,teddy bear <br> Weight:1Kg</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/baby_hamper1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Baby's Hamper</span>
            <a href="">Little Miracle</a>
            <h4>Rs.2399</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/baby_hamper2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Baby's Hamper</span>
            <a href="">Baby Bundle</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/baby_hamper3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Baby's Hamper</span>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/baby_hamper4.jpeg" alt="" />
            </a>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/baby hamper.jpeg"; // Replace this with the actual image path or dynamically fetch it
