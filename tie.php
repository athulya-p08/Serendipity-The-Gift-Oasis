    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/tie.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Tie</h4></span>
          <h1>Royal Color Tie Set</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Royal Color Tie Set',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Royal Color Tie Set',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Tie</h2> 
            <br>
            <h4>Add a touch of sophistication to your outfit with our classic striped tie made from high-quality silk with subtle sheen and smooth texture of the silk ensuring that you look and feel great.</p>
            <br><br>
        Material:High-quality smooth silk<br> Color:Maroon, Navy Blue, Royal Blue, Violet <br> Care instructions:Dry clean only<br> Speciality:Luxurious texture, versatile color combination, easy to care</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tie1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Tie</span>
            <a href="">Multi-colored tie</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tie2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Tie</span>
            <a href="">Maroon tie with texture</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tie3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Tie</span>
            <a href="">Green tie with mini texture</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tie4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Tie</span>
            <a href="">BLue tie with texture</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/tie.jpeg"; // Replace this with the actual image path or dynamically fetch it
