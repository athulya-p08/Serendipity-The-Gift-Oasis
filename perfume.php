    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/lux perfume.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Orchid Leather Perfume</h4></span>
          <h1>Van Cleef & Arpels</h1>
          <div class="price">Rs.24999</div>
          <form class="form">
            <a class="cart button" onclick="addToCart('Van Cleef & Arpels',24999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Van Cleef & Arpels',24999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Luxury Perfume</h2> 
            <br>
            <h4>Indulge in opulence of our elegant luxury perfume. A sophisticated blend of flowers, spices and woods. This exquisite fragrance is designed to evoke the essence of luxury and refinement.</p>
            <br><br>
        Fragrance:Eau-de-parfum 15%<br> Top-note:Black pepper mandarin <br> Packaging:Heavy glass bottle with a luxurious lid <br> Speciality:Long-lasting, elegant scent, refined aroma</h4>
      ...
      <div class="product-center container">
        <div class="product-item">
          ...
          <div class="product-info">
            ...
            <a href="">Dolce & Gabbana Perfume</a>
            <h4>Rs.19999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>Luxury Perfume</span>
            <a href="">Hypnotic Poison Perfume</a>
            <h4>Rs.29999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/lux perfume.jpeg"; // Replace this with the actual image path or dynamically fetch it
