...
<?php
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/accessories.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Accessories</h4></span>
          <h1>Accsessories Set</h1>
          <div class="price">Rs.799</div>
          
          <form class="form">
           
            <a class="cart button" onclick="addToCart('Accessories Set',799,document.getElementById('quantity').value)">Add To Cart</a>
          
        
            <a class="button wishlist-btn" onclick="addToWishlist('Accessories Set', 799)">Add to Wishlist</a>
          ...
          <p>
            <h2>Accessories</h2> 
            <br>
            <h4>Elevate your style with a classic, sophesticated designs. This beautiful set adds a modern twist making it perfect for any occasion.</p>
            <br><br>
        Material:High-quality, long-lasting<br> Suitable for:Women<br> Care instructions:Avoid exposure to direct sunlight, avoid water <br> Products:Studs, Rings and hangings</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/accessories1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Accessories</span>
            <a href="">Spiral hair-tie (Pack of 2 set)</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/accessories2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Accessories</span>
            <a href="">Collection of purple earrings</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/accessories3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Accessories</span>
            <a href="">Collection of purple rings</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/accessories4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Accessories</span>
            <a href="">Chain with butterfly locket</a>
            <h4>Rs.449</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
    ...
    const image = "./images/accessories.jpeg"; // Replace this with the actual image path or dynamically fetch it
...
<script>
  ...
  function updateWishlistCount() {
    ...
    const wishlistCountElement = document.querySelector(".bx-heart span");
