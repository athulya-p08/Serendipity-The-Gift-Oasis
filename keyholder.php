    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/keyholder.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Keyholder</h4></span>
          <h1>Key Shaped Key Holder</h1>
          <div class="price">Rs.599</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Key Shaped Key Holder',599,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Key Shaped Key Holder',599)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Keyholder</h2> 
            <br>
            <h4>Elevate your entryway or offce with our modern and premium keyholder. This keyholder combines functionality with sophisticated design, which never allows you to misplace your keys again.</p>
            <br><br>
        Material:Wood,wood-toned color <br> Suitable for:Office,Home owners,Appartments <br> Key type:Accomodates standard house keys,car keys and padlock keys<br> Speciality:Suitable for indoor and outdoor,Durable space-saving design</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/keyholder1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Keyholder</span>
            <a href="">Citrus hold</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/keyholder2.jpeg" alt="" />
            </a>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/keyholder3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Keyholder</span>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/keyholder4.jpeg" alt="" />
            </a>
...
<script>
 function addToCart(name, price, quantity) {
    const image = "./images/keyholder.jpeg"; // Replace this with the actual image path or dynamically fetch it
