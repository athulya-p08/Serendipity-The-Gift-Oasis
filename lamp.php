    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Lamp.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Lamp</h4></span>
          <h1>Flower Shaped Lamp</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Flower Shaped Lamp',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Flower Shaped Lamp',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Lamp</h2> 
            <br>
            <h4>Brighten up your space with our beautiful flower-shaped lamp. This unique and charming lamp is designed to resemble a blooming flower, adding a touch of elegancea nd whimsy to any room.</p>
            <br><br>
        Material:High-quality ceramic,soft-pastel shades<br> Suitable for:Bed-side table,living room,office <br> Bulb type:LED(6-12 watts) <br> Speciality:Energy efficient LED bulbs,sturdy base and soft-glow(warm light)</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/lamp1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Lamp</span>
            <a href="">Floral dream</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/lamp2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Lamp</span>
            <a href="">Spring awakening</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/lamp3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Lamp</span>
            <a href="">Innocent glow</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/lamp4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Lamp</span>
            <a href="">Cherry blossom dream</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
 function addToCart(name, price, quantity) {
    const image = "./images/Lamp.jpeg"; // Replace this with the actual image path or dynamically fetch it
