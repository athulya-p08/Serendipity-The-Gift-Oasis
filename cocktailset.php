    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/cocktail kit.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Cocktail Set</h4></span>
          <h1>All in one Cocktail Set</h1>
          <div class="price">Rs.2999</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('All-in-one Cocktail Set',2999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('All-in-one Cocktail Set',2999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Cocktail Set</h2> 
            <br>
            <h4>Take your cocktail game to the next level with our ultimate cocktail set, a comprehensive collection of premium spirit mixtures and garnishes. Beautifully crafted tools and accessories.</p>
            <br><br>
        Tools and accessories:Muddler, jigger, shaker, strainer <br> Suitable for:Bartenders, Party host, Cocktail enthusiasts <br> Speciality:With cocktail recipe book, durable, BPA free</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/cocktailset1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Cocktail Set</span>
            <a href="">Canisa glass mixology</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/cocktailset2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Cocktail Set</span>
            <a href="">Golden cocktail set</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/cocktailset3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Cocktail Set</span>
            <a href="">Sunset cocktail set</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/cocktailset4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Cocktail Set</span>
            <a href="">Classic black cocktail set</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/cocktail kit.jpeg"; // Replace this with the actual image path or dynamically fetch it
