    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/chocolate set.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Chocolate Hamper</h4></span>
          <h1>Ferrero Rocher Hamper</h1>
          <div class="price">Rs.1999</div>
         
          <form class="form">
            <a class="cart button" onclick="addToCart('Ferrero Rocher Hamper',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Ferrero Rocher Hamper',1999)">Add To Wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Chocolate Hamper</h2> 
            <br>
            <h4>Treat your loved ones to a thoughtful and indulgent gift hamper, carefully curated with a selection of chocolates. Our hampers are perfect for any occasion, whether it's a birthday, anniversary, or just because. Each hamper is beautifully presented and includes a personalized gift message to make it extra special.</p>
            <br><br>
        Hamper Size:Medium <br> Suitable for:Birthdays,anniversary,get well soon,etc <br> Products included:Ferrero Rocher chocolate set,teddy bear <br> Weight:1Kg</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/chocohamper1.jpeg" alt="" />
            </a>
          </div>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/chocohamper2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Chocolate Hamper</span>
            <a href="">Coffee Rush</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/chocohamper3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Chocolate Hamper</span>
            <a href="">Sweet Delight Hamper</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/chocohamper4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Chocolate Hamper</span>
            <a href="">Treat Trove Hamper</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/chocolate set.jpeg"; // Replace this with the actual image path or dynamically fetch it
