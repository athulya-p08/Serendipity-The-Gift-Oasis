    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Mug.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Birthday Mug</h4></span>
          <h1>White Birthday Themed Mug</h1>
          <div class="price">Rs.249</div>
          
          <form class="form">
            
            <a class="cart button" onclick="addToCart('White Birthday Themed Mug',249,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('White Birthday Themed Mug',249)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Happy Birthday Mug</h2>
            <br>
            <h4>Celebrate a special birthday with this thoughtful and functional white cerammic mug!!!<br>This mug is sure to bring a smile to their face on a special day.<br>
            Durable, dish-washer safe and featuring a vibrant birthday design.
          <br></p><br><br>
        Material:White Ceramic <br> Capacity:250ml <br> Packaging:Individually boxed <br> Style:Modern,Classic,Simple</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mug1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Mug</span>
            <a href="">Multi-colored birthday mug</a>
            <h4>Rs.249</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mug2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Birthday Mug</span>
            <a href="">Simple white cake printed mug</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mug3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Mug</span>
            <a href="">Party themed birthday mug</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mug4.jpeg" alt="" />
            </a>
    
          </div>
          <div class="product-info">
            <span>Birthday Mug</span>
            <a href="">Multi-colored happy birthday themmed mug</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Mug.jpeg"; // Replace this with the actual image path or dynamically fetch it
