    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/women's hamper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Women's Hamper</h4></span>
          <h1>Hamper For Her</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Hamper For Her',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Hamper For Her',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Women's Hamper</h2> 
            <br>
            <h4>Indulge her senses with luxurious treats and pampering delights. This thoughtfully curated hamper is tailored to her unique style and tastes. Featuring gourmet goodies, rejuvenating skincare and beautiful accessories. Perfect for special occassions or everyday indulgence. A beautiful way to show your love and appreciation.</p>
            <br><br>
        Hamper size:Medium <br> Suitable for:Birthday,Anniversary,Festivals,Occassions <br> Products included:Saree,Bow,Earrings,Bangles,chocolates <br> Weight:1Kg</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/womens_hamper1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Women's Hamper</span>
            <a href="">The Queen's Collection</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/womens_hamper2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Women's Hamper</span>
            <a href="">The Beauty Box</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/womens_hamper3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Women's Hamper</span>
            <a href="">Pamper Me Box</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/womens_hamper4.jpeg" alt="" />
            </a>
         
          </div>
          <div class="product-info">
            <span>Women's Hamper</span>
            <a href="">The Goddess's Gift</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/women's hamper.jpeg"; // Replace this with the actual image path or dynamically fetch it
