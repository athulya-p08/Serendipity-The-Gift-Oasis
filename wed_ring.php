    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Rings.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Rings</h4></span>
          <h1>Gold Plated Rings</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Gold Plated Rings',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Gold Plated Rings',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Rings</h2> 
            <br>
            <h4> Seal your love forever with our exquisite couple rings expertly crafted to symbolize your eternal bond. This beautifully designed matching his and her rings is the perfect token of love and commitment.</p>
            <br><br>
        Size:Default<br> Material:Gold plated <br> Suitable for:Anniversary,wedding,valentines day <br> Speciality:Comfort fit design,Classic,Modern</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/ring1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Rings</span>
            <a href="">Sun-Moon (Gold-Silver) Rings</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>Rings</span>
            <a href="">Star-Moon themed rings</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
   function addToCart(name, price, quantity) {
    const image = "./images/Rings.jpeg"; // Replace this with the actual image path or dynamically fetch it
