    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Champagne.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Champagne</h4></span>
          <h1>Exotic Champagne</h1>
          <div class="price">Rs.4999</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Exotic Champagne',4999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Exotic Champagne',4999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Champagne</h2> 
            <br>
            <h4>Experience the epitome of luxury with our prestige chamgane crafted to perfection. This exquisite champagne is a blend of the finest ingredients,carefully selected and aged to create a truly exceptional taste experience.</p>
            <br><br>
        Material:Grape variety,glass bottle,cork closure<br> Suitable for:Special occasions,formal events,gifting <br> Care instructions:Store in a cool place, avoid exposure to direct sunlight, handle with care <br> Speciality:Prestige champagne made from a blend of the finest grapes.</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/champagne1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Champagne</span>
            <a href="">Laurent-Perrier Champagne</a>
            <h4>Rs.3499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/champagne2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Champagne</span>
            <a href="">MOET & CHANDON Champagne</a>
            <h4>Rs.3999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/champagne3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Champagne</span>
            <a href="">NOZECO ROSE Champagne</a>
            <h4>Rs.4499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/champagne4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Champagne</span>
            <a href="">BROKEN EARTH WINERY</a>
            <h4>Rs.4999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Champagne.jpeg"; // Replace this with the actual image path or dynamically fetch it
