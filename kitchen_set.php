    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/kitchen set.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Kitchen Set</h4></span>
          <h1>Multicolor Kitchen Set</h1>
          <div class="price">Rs.299</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Multicolor Kitchen Set',299,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Multicolor Kitchen Set',299)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Kitchen Set</h2> 
            <br>
            <h4> Spark imagination and culinary creativity with our kitchen play set.<br> This interactive cooking set is designed for kids to explore the world of cooking,learning about essential skills.</p>
            <br><br>
        Size:Default<br> Material:Plastic(BPA-free) <br> Suitable for:3-8 yrs <br> Speciality:Durable BPA-free construction</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/kitchen_set1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Kitchen Set</span>
            <a href="">Pink themed kitchen set</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/kitchen_set2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Kitchen Set</span>
            <a href="">Coffe-shop themed kitchen set</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/kitchen_set3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Kitchen Set</span>
            <a href="">Pastel colored kitchen set</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/kitchen_set4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Kitchen Set</span>
            <a href="">Ice-cream shop themed kitchen set</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/kitchen set.jpeg"; // Replace this with the actual image path or dynamically fetch it
