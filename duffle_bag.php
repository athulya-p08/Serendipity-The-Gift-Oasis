    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/duffle bag.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Duffle Bag</h4></span>
          <h1>Black Leather Bag</h1>
          <div class="price">Rs.2999</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Black Leather Bag',2999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Black Leather Bag',2999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Duffle Bag</h2> 
            <br>
            <h4>Get ready for your next adventure with our duffle bag. The multiple pockets and compartments provide ample storage for all your gear.</p>
            <br><br>
        Material:Durable water-resistant material<br> Suitable for:Travellers, Athletes, Campers<br> Care instructions:Wipe clean with damp cloth <br> Speciality:Zipper closure with reinforced stitching, comfortable, long-lasting</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dufflebag1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Duffle Bag</span>
            <a href="">Denim matrial duffle bag</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dufflebag2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Duffle Bag</span>
            <a href="">Leather Duffle bag</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dufflebag3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Duffle Bag</span>
            <a href="">Leather brown-black duffle bags</a>
            <h4>Rs.5999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dufflebag4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Duffle Bag</span>
            <a href="">Dark-brown leathered duffle bag</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/duffle bag.jpeg"; // Replace this with the actual image path or dynamically fetch it
