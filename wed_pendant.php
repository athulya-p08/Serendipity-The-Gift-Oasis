    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/couple pendant.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Couple Pendant</h4></span>
          <h1>Crystal Couple Pendant</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Crystal Couple Pendant',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Crystal Couple Pendant',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Couple Pendant</h2> 
            <br>
            <h4> Symbolize your eternal love with our beautifully crafted entwined couple pendant.<br> This stunning pendant represents the unbreakable bond between two souls.</p>
            <br><br>
        Chain length:16 inch<br> Material:Sterling silver with crystal <br> Suitable for:Anniversary,wedding,valentines day <br> Speciality:Luxurious feel,perfect for everyday wear</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_pendant1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple Pendant</span>
            <a href="">Sparkle themed pendants</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_pendant2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Couple Pendant</span>
            <a href="">Cute ghost themed pendant</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_pendant3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple Pendant</span>
            <a href="">Universe themed pendant</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_pendant4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Couple Pendant</span>
            <a href="">Night themed pendant</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/couple pendant.jpeg"; // Replace this with the actual image path or dynamically fetch it
