    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Photoframe.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Frame</h4></span>
          <h1>Mini Wooden Frame</h1>
          <div class="price">Rs.599</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Mini Wooden Frame',599,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Mini Wooden Frame',499)">Add to wishlist</a>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Photoframe.jpeg"; // Replace this with the actual image path or dynamically fetch it
