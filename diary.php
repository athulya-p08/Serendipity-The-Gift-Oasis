    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/diary.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Diary</h4></span>
          <h1>200 Page Diary</h1>
          <div class="price">Rs.299</div>
         
          <form class="form">
            
            <a class="cart button" onclick="addToCart('200 Page Diary',299,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('200 Page Diary',299)">Add to wishlist</a>
          
          <h3>Product Detail</h3>
          <p>
            <h2>Diary</h2> 
            <br>
            <h4>Unlock the power of self-reflection and creativity with this beautifully designed journal that is a perfect companion for anyone looking to record their thoughts, idea and inspiration.</p>
            <br><br>
        Material:Smooth acid-free paper<br> Suitable for:students, individuals seeking self-improvement, travellers<br> Standard Edition : 200 pages <br> Speciality : Beautiful design, flexible layout, inspirational quotes.</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diary1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diary</span>
            <a href="">Baby pink-golden Diary</a>
            <h4>Rs.249</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diary2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Diary</span>
            <a href="">Grey diary along with a heart-shaped lock</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diary3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diary</span>
            <a href="">Vintage style diary</a>
            <h4>Rs.429</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diary4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Diary</span>
            <a href="">Astronomy themed diary</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/diary.jpeg"; // Replace this with the actual image path or dynamically fetch it
