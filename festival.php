...
<html lang="en">
  <head>
    ...
    <title>Festivals Category</title>
  </head>
...
<?php
    ...
    <section class="section all-products" id="products">
      ...
      <div class="product-center container">
        <div class="product-item" data-price="299" data-name="Diya (Lotus)" onclick="document.location='diya.php'">
          <div class="overlay">
            <a href="productDetails.html" class="product-thumb">
              <img src="./images/diya.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>DIYA</span>
            <a href="productDetails.html">Diya (Lotus)</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item" data-price="199" data-name="Seven Rangoli Colors" onclick="document.location='holi.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/holi colors.jpeg" alt="" />
            </a>
         
          </div>
          <div class="product-info">
            <span>HOLI COLORS</span>
            <a href="">Seven Rangoli Colors</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="99" data-name="Rakhi Combo" onclick="document.location='rakhi.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/rakhi.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>RAKSHA BANDHAN</span>
            <a href="">Rakhi Combo</a>
            <h4>Rs.99</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-center container">
        <div class="product-item" data-price="699" data-name="Kathakali Frame" onclick="document.location='onam.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/kathakali.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>ONAM</span>
            <a href="">Kathakali Frame</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="899" data-name="Diwali Sweets Box" onclick="document.location='diwali.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/sweets box.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>DIWALI</span>
            <a href="">Diwali Sweets Box</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="1999" data-name="Christmas Cookie Hamper" onclick="document.location='christmas.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
          ...
          <div class="product-info">
            <span>CHRISTMAS</span>
            <a href="">Christmas Cookie Hamper</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
