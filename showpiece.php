    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/ganesha.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Ganesha Idol</h4></span>
          <h1>Golden Ganesh Idol Showpiece</h1>
          <div class="price">Rs.2999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Golden Idol Showpiece',2999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Golden Idol Showpiece',2999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Showpiece</h2> 
            <br>
            <h4>Bring home the blessings of Lord Ganesha with our exquisite idol showpiece. Crafted with precision and attention to detail, this stunning piece is sure to add a touch of divinity to your home or office. This showpiece features intricate carvings and designs, adding to its beauty and charm.</p>
            <br><br>
        Material:Brass <br> Suitable for:Home decor,office decor,Gift-giving <br> Care instructions:Avoid exposing to direct sunlight,Handle with care to avoid damage <br> Speciality:Intricately carved and designed</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/ganesha1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Showpiece</span>
            <a href="">Auspicious Ganesha</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/ganesha2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Showpiece</span>
            <a href="">Divine Showpiece</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/ganesha3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Showpiece</span>
            <a href="">Ganesha Figurine</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/ganesha4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Showpiece</span>
            <a href="">Handcrafted Ganesha Statue</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/ganesha.jpeg"; // Replace this with the actual image path or dynamically fetch it
