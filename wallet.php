    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/wallet.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Men's Wallet</h4></span>
          <h1>Black Leather Wallet</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Black Leather Wallet',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Black Leather Wallet',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Men's Wallet</h2> 
            <br>
            <h4>Carry your essentials in style with our classic leather wallet. The classic design and functional layout make it perfect for everyday use.</p>
            <br><br>
        Material:High-quality genuine leather<br> Suitable for:Men and Women<br> Care instructions:Avoid exposure to sunlight, Store in cool dry place <br> Speciality:One-cash compartment, Steady snap-button, six card slots</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallet1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Men's Wallet</span>
            <a href="">Brown textured wallet</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallet2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Men's Wallet</span>
            <a href="">Dark-brown textured wallet</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallet3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Men's Wallet</span>
            <a href="">baellerry's wallet</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallet4.jpeg" alt="" />
            </a>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/wallet.jpeg"; // Replace this with the actual image path or dynamically fetch it
