    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/tumbler.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Tumbler</h4></span>
          <h1>Glass Tumbler with Straw</h1>
          <div class="price">Rs.499</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Glass Tumbler with Straw',499,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Glass Tumbler with Straw',499)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Tumbler</h2> 
            <br>
            <h4>Brighten up your day with our adorable tumbler. This charming drink wear is designed to bring a touch of whimsy.</p>
            <br><br>
            Material:Glass with wooden lid<br> Suitable for:students and office workers <br> Care instructions:hand wash only, not dishwasher safe. <br> Speciality:Spill-proof lid to prevent accidents</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tumbler1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Tumbler</span>
            <a href="">McD themed tumbler</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tumbler2.jpeg" alt="" />
            </a>
          
          </div>
          <div class="product-info">
            <span>Tumbler</span>
            <a href="">Aesthetic tumbler</a>
            <h4>Rs.599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tumbler3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Tumbler</span>
            <a href="">Coffee themed tumbler</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/tumbler4.jpeg" alt="" />
            </a>
      
          </div>
          <div class="product-info">
            <span>Tumbler</span>
            <a href="">Glass tumbler with mini print</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/tumbler.jpeg"; // Replace this with the actual image path or dynamically fetch it
