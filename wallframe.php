    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/wallframe.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Wall Frame</h4></span>
          <h1>Multi-set Wall Frame</h1>
          <div class="price">Rs.899</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Multi-Set Wall Frame',899,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Multi-Set Wall Frame',899)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Wall Frame</h2> 
            <br>
            <h4>Add a touch of sophistication to ypur walls with our elegant multi-set wallframe, featuring a premium design which is perfect for enhancing any room's decor.</p>
            <br><br>
        Material:Acrylic painting <br> Size:4x6,5x7,8x10 <br> Care instructions:Avoid touching acrylic paint to prevent fingerprints,Avoid scratches or damage,Dust the frame regularly with a soft,dry cloth <br> Speciality:Acid-free materials,Durable,Easy-insallation</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallframe1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Wall Frame</span>
            <a href="">Wings of Wonder</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallframe2.jpeg" alt="" />
            </a>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallframe3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Wall Frame</span>
            <a href="">Celestial Balance</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wallframe4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Wall Frame</span>
            <a href="">Subtle Sophistication</a>
            <h4>Rs.1799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/wallframe.jpeg"; // Replace this with the actual image path or dynamically fetch it
