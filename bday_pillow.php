    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/bday pillow.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Birthday Pillow</h4></span>
          <h1>White Colored Pillow with Birthday Print</h1>
          <div class="price">Rs.249</div>
         
          <form class="form">
            <a class="cart button" onclick="addToCart('White Colored Pillow with Birthday Print',249,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('White Colored Pillow with Birthday Print',249)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Birthday Piilow</h2>
            <br>
            <h4> Celebrate in comfort!!<br> Our happy birthday pillow is the perfect addition to any birthday party. It adds a pop of color and comfort to their celebration.</p>
            <br><br>
        Size:12x12<br> Material:Polyster <br> Fill-material:Polyster-fibrefill <br> Speciality:Machine Washable, Dry clean</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday_pillow1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Pillow</span>
            <a href="">White multi-colored birthday pillow</a>
            <h4>Rs.249</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday_pillow2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Birthday Pillow</span>
            <a href="">Black-colored birthday pillow</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday_pillow3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Pillow</span>
            <a href="">Pink-colored birthday pillow</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday_pillow4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Birthday Pillow</span>
            <a href="">Special birthday themed pillow</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/bday pillow.jpeg"; // Replace this with the actual image path or dynamically fetch it
