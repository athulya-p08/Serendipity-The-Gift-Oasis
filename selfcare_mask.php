    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/sleeping mask.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Self Care Mask</h4></span>
          <h1>Set of Mask & Neck Pillow</h1>
          <div class="price">Rs.699</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Set of Mask & Neck Pillow',699,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Set of Mask & Neck Pillow',699)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Self Care Mask</h2> 
            <br>
            <h4>Say ggodbye to neck strain and discomfort with our comfortable neck pillow. Designed to provide optimal support and comfort, this pillow is perfect for anyone who spends long hours travelling, working or relaxing.</p>
            <br><br>
        Material:Super soft breathable material that are build to last<br> Suitable for:Readers, office workers, travellers <br> Care instructions:machine wash cold, gentle cycle<br> Speciality:lightweight and cushion like comfort</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/neckpillow1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Care Mask</span>
            <a href="">Brown cat themed neck pillow and sleeping mask</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/neckpillow2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Self Care Mask</span>
            <a href="">Grey-Pink combo neck pillow and sleeping mask</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/neckpillow3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Care Mask</span>
            <a href="">Penguin themed neck pillow</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/neckpillow4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Self Care Mask</span>
            <a href="">Strawberry themed neck pillow</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/sleeping mask.jpeg"; // Replace this with the actual image path or dynamically fetch it
