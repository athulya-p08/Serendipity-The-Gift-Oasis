    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/men's hamper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Men's Hamper</h4></span>
          <h1>Hamper For Him</h1>
          <div class="price">Rs.2999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Hamper For Him',2999,document.getElementById('quantity').value)">Add to Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Hamper For Him',299)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Men's Hamper</h2> 
            <br>
            <h4>Indulge him in the finest luxuries,carefully curated to pamper his senses.</p>
            <br><br>
        Hamper size:Medium <br> Suitable for:Birthday,Anniversary,Gifting <br> Products included:Face wash,Comb,Body wash,Towel <br> Weight:1Kg</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mens_hamper1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Men's Hamper</span>
            <a href="">The Gentleman's Chest</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mens_hamper2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Men's Hamper</span>
            <a href="">The Emperor's Box</a>
            <h4>Rs.1399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mens_hamper3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Men's Hamper</span>
            <a href="">The Luxury Lounge</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/mens_hamper4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Men's Hamper</span>
            <a href="">The Regal Reserve</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/men's hamper.jpeg"; // Replace this with the actual image path or dynamically fetch it
