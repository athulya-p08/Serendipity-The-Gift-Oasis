    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/bday hamper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Birthday Hamper</h4></span>
          <h1>Birthday Hamper</h1>
          <div class="price">Rs.1999</div>
        
          <form class="form">
            <a class="cart button" onclick="addToCart('Birthday Hamper',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Birthday Hamper',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Birthday Hamper</h2> 
            <br>
            <h4>Make their birthday even more special with our birthday hamper. Perfect for friends,family or loved ones. Our birthday hamper is a wonderful way to show you care.</p>
            <br><br>
        Hamper size:Medium<br> Suitable for:Birthday <br> Color:Purple <br> Products included:Mini banner,bag,body wash,face mask,scrunchie.</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bdayhampaer1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Hamper</span>
            <a href="">Birthday Bliss Hamper</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bdayhampaer2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Birthday Hamper</span>
            <a href="">Birthday Delight Hamper</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bdayhampaer3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Hamper</span>
            <a href="">Birthday Treat Trove</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bdayhampaer4.jpeg" alt="" />
            </a>
          
          </div>
          <div class="product-info">
            <span>Birthday Hamper</span>
            <a href="">Birthday Indulgence Hamper</a>
            <h4>Rs.799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/bday hamper.jpeg"; // Replace this with the actual image path or dynamically fetch it
