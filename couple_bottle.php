    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/bottle.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Mr. & Mrs. Bottle Set</h4></span>
          <h1>Black-White Bottle Set</h1>
          <div class="price">Rs.699</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Black-White Bottle Set',699,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Black-White Bottle Set',699)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Mr. & Mrs. Bottle Set</h2> 
            <br>
            <h4> Celebrate love with our couple bottle. Get your engraved his and hers bottle today!!<br> It is best for romantic keep sake.</p>
            <br><br>
        Size:750ml<br> Material:Premium glass <br> Suitable for:Anniversary,wedding,valentines day <br> Speciality:Engraved with Mr. and Mrs.</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bottle1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple's Bottle Set</span>
            <a href="">Black-Pink themed couple's bottle</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bottle2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Couple's Bottle Set</span>
            <a href="">Black-White themed bottle with straw</a>
            <h4>Rs.1599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bottle3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Couple's Bottle Set</span>
            <a href="">Flower printed bottle</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bottle4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Couple's Bottle Set</span>
            <a href="">Pastel themed bottle with straw</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/bottle.jpeg"; // Replace this with the actual image path or dynamically fetch it
