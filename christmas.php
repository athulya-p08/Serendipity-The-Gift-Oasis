    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/christmas.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Christmas</h4></span>
          <h1>Christmas Cookie Hamper</h1>
          <div class="price">Rs.1999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Christmas Cookie Hamper',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Christmas Cookie Hamper',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Christmas</h2> 
            <br>
            <h4>Indulge in the sweets spirit of christmas with our delightful cookie hamper. The hamper is carefully curated with an assortment of freshly baked cookies, perfect for snacking,gifting or sharing with loved ones.</p>
            <br><br>
        Cookie varieties:Classic Sugar,Chocolate crinkle and Gingerbread  <br> Care instructions:Store cookies in a air-tight container,Consume within 5 days <br> Speciality:Handcrafted cookies,High-quality ingredients and Seasonal Flavors</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/christmas1.jpeg" alt="" />
            </a>
          </div>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/christmas2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Christmas</span>
            <a href="">Sparkling Snowflake</a>
            <h4>Rs.799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/christmas3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Christmas</span>
            <a href="">Winterwood Manor</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/christmas4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Christmas</span>
            <a href="">Holly Berry Wreath</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/christmas.jpeg"; // Replace this with the actual image path or dynamically fetch it
