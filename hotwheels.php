    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/hot wheel's.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Hotwheels</h4></span>
          <h1>Hotwheels 50 Car Gift Set</h1>
          <div class="price">Rs.3999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Hotwheels 50 Car Gift Set',3999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Hotwheels 50 Car Gift Set',3999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Hotwheels</h2> 
            <br>
            <h4> Unleash adrenaline-fueled action with the Hotwheels car set.<br> This epic racing and stunning playset leds kids create,customize their way to high speed fun.</p>
            <br><br>
        Size:Default<br> Material:Plastic(BPA-free) <br> Suitable for:4-10 yrs <br> Speciality:Consists of Cars,Instructors and connectors</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/hotwheels1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Hotwheels</span>
            <a href="">Pink fast and furious themed cars</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/hotwheels2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Hotwheels</span>
            <a href="">Hotwheel bugatti bolide</a>
            <h4>Rs.1899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/hotwheels3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Hotwheels</span>
            <a href="">Pink classic hotwheel set</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/hotwheels4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Hotwheels</span>
            <a href="">Lightning McQueen set</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/hot wheel's.jpeg"; // Replace this with the actual image path or dynamically fetch it
