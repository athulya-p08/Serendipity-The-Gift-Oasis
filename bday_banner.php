    ...
    <div class="navigation">
      <div class="nav-center container d-flex">
        ...
        <div class="icons d-flex">
          ...
          </a><a href="search.html" class="icon">
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/bday banner.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Birthday Banner</h4></span>
          <h1>White-Golden Birthday Banner</h1>
          <div class="price">Rs.199</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('White-Golden Birthday Banner',199,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('White-Golden Birthday Banner',199)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Birthday Banner</h2>
            <br>
            <h4>Make their special day unforgettable with our vibrant and trendy happy birthday banner!!<br> 
            Perfect for birthday parties that adds a personal touch to your decor.</p>
            <br><br>
         Size:5 ft<br> Material:Vinyl <br> Color:White and Golden <br> Quality:Reusable and durable material</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday banner1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Banner</span>
            <a href="">Black-Silver Combo banner</a>
            <h4>Rs.99</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday banner2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Birthday Banner</span>
            <a href="">Golden Banner</a>
            <h4>Rs.119</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday banner3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Banner</span>
            <a href="">Birthday banner with lights</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/bday banner4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Birthday Banner</span>
            <a href="">Golden-black combo banner</a>
            <h4>Rs.99</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/bday banner.jpeg"; // Replace this with the actual image path or dynamically fetch it
