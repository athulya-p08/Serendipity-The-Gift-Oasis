    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/lux_candle.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Healin Candle</h4></span>
          <h1>Lavender Crystalized Candle</h1>
          <div class="price">Rs.1999</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Lavender Crystalized Candle',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Lavender Crystalized Candle',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Luxury Candle</h2> 
            <br>
            <h4>Indulge in the tranquil ambiance of our luxurious candle expertly crafted to provide a serene and relaxing atmosphere. This premium candle features a unique blend of essential oils and wax formula.</p>
            <br><br>
        Wax type:Beeswax <br> Suitable for:Relaxing atmosphere, aroma therapy, gift-giving <br> Care instructions:Trim wick to 1 inch before each use <br> Speciality:Lavender scent, burn time 60-80 hours, soft and creamy white color</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/candle1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Luxury Candle</span>
            <a href="">Strawberry pound cake candle</a>
            <h4>Rs.1799</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/candle2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Luxury Candle</span>
            <a href="">Birthday themed candle</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/candle3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Luxury Candle</span>
            <a href="">Sweater Weather Candle</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/candle4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Luxury Candle</span>
            <a href="">Mahogany Teakwood Candle</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/lux_candle.jpeg"; // Replace this with the actual image path or dynamically fetch it
