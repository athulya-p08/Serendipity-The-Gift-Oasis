    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/rakhi.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Rakhi</h4></span>
          <h1>Rakhi Combo</h1>
          <div class="price">Rs.99</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Rakhi Combo',99,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Rakhi Combo',99)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Rakhi</h2> 
            <br>
            <h4>Celebrate the special bond between brothers and sisters with our exquisite handmade rakhi, intricately designed with love and care. This rakhi is a symbol of unconditional love and affection that siblings share.</p>
            <br><br>
            Material:Silk thread,beads and decorative materials <br> Packaging:Comes in a decorative pouch <br> Care instructions:Store in a dry place to preserve the threads and beads <br> Speciality:Unique handmade desugn that adds a personal touch to rakhi celebration</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/rakhi1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Rakhi</span>
            <a href="">Silver Splendor</a>
            <h4>Rs.59</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/rakhi2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Rakhi</span>
            <a href="">Luxurious bond</a>
            <h4>Rs.49</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/rakhi3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Rakhi</span>
            <a href="">Elegant embrace</a>
            <h4>Rs.99</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/rakhi4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>rakhi</span>
            <a href="">Rakhi Radiance</a>
            <h4>Rs.59</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/rakhi.jpeg"; // Replace this with the actual image path or dynamically fetch it
