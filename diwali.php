    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/sweets box.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Diwali</h4></span>
          <h1>Diwali Sweets Box</h1>
          <div class="price">Rs.899</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Diwali Sweets Box',899,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Diwali Sweets Box',899)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Diwali</h2> 
            <br>
            <h4>Celebrate the festival of lights with our exclusive diwali sweet's box. A carefully curated selection of traditional indian sweets made with the finest ingredients which gives an unforgettable taste experience.</p>
            <br><br>
        Sweets:Gulab Jamun,Barfi,Ladoo and many more <br> Care instructions:Avoid moisture,Check expiration dates,Handle with care <br> Speciality:No artificial preservatives,High-quality ingredients,Variety of sweets</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diwali1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diwali</span>
            <a href="">Diwali Delights</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diwali2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Diwali</span>
            <a href="">Sweet Serenade</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diwali3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diwali</span>
            <a href="">Taste of Tradition</a>
            <h4>Rs.799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diwali4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Diwali</span>
            <a href="">Festival Flavors</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/sweets box.jpeg"; // Replace this with the actual image path or dynamically fetch it
