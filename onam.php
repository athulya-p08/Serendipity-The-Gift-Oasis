    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/kathakali.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Onam</h4></span>
          <h1>Kathakali Frame</h1>
          <div class="price">Rs.699</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Kathakali Frame',699,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Kathakali Frame',699)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Onam</h2> 
            <br>
            <h4>Celebrate the spirit of Onam with our stunning Kathakali frame. This exquisite piece of art is a beautiful  tribute to Kerala's rich cultural heritage.</p>
            <br><br>
        Material:High quality painting,wooden frame <br> Suitable for:Living room,Hallway,Office <br> Size:12 inches(30cm) x 18 inches(45cm) <br> Speciality:Unique and intricate design that showcases Kerala's rich cultural heritage, Can be hung on a wall or placed on a table</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/onam1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Onam</span>
            <a href="">Rhythm of life</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/onam2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Onam</span>
            <a href="">Dance of the divine</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/onam3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Onam</span>
            <a href="">Gujarat's glory</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/onam4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Onam</span>
            <a href="">Masked Majesty</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/kathakali.jpeg"; // Replace this with the actual image path or dynamically fetch it
