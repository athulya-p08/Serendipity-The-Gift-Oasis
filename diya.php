    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/diya.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Diya</h4></span>
          <h1>Diya (Lotus)</h1>
          <div class="price">Rs.299</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Diya (Lotus)',299,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Diya (Lotus)',299)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Diya</h2> 
            <br>
            <h4>Add a warm and festive glow to your home with this premiumly crafted diyas. This traditional lamp is designed to bring light, prosperity and positivity to your space. This diya is sure to become a cherished part of your home.</p>
            <br><br>
        Material:Brass,wood <br> Suitable for:Diwali celecration,Home decor,Prayer <br> Care instructions:Wipe with soft cloth,Change the oil regularly,Avoid stacking <br> Speciality:Long-lasting,Carefully handicrafted,Cultural and spiritual significance</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diya1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diya</span>
            <a href="">Lotus bloom</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diya2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Diya</span>
            <a href="">Classic heritage</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diya3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Diya</span>
            <a href="">Luminous Luxe</a>
            <h4>Rs.249</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/diya4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Diya</span>
            <a href="">Kaleidoscope Glow</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/diya.jpeg"; // Replace this with the actual image path or dynamically fetch it
