...
<html lang="en">
  <head>
    ...
    <title>Birthday Chocolate Hamper</title>
  </head>
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/choco hamp.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Birthday Chocolate Hamper</h4></span>
          <h1>Kitkat Choco Hamper</h1>
          <div class="price">Rs.399</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('KitKat Choco Hamper',399,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('KitKat Choco Hamper',399)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Birthday Chocolate Hamper</h2>
            <br>
            <h4>Indulge in the ultimate chocolate experience with our KitKat cake shaped hamper!! <br> This delightful gift is meticulously crafted to resemble a cake, filled with an assortment of KitKat signature chocolate bars. </p>
            <br><br>
        Hamper size:3 Layered<br> Units:35 <br> Flavors:Original,Dark,White <br> Highlight:Limited edition</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/choco1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Chocolate Hamper</span>
            <a href="">Lolipop shaped Eclair Hamper</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/choco2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Birthday Chocolate Hamper</span>
            <a href="">Bouque shaped Dairy Milk hamper</a>
            <h4>Rs.599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/choco3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Birthday Chocolate Hamper</span>
            <a href="">Cake shaped Diary Milk hamper</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/choco4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Birthday Chocolate Hamper</span>
            <a href="">Single layered cake shaped Choco hamper</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/choco hamp.jpeg"; // Replace this with the actual image path or dynamically fetch it
