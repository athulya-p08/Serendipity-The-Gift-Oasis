    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/wed frame.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Wedding Frame</h4></span>
          <h1>White Wedding Frame</h1>
          <div class="price">Rs.299</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('White Wedding Frame',299,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('White Wedding Frame',299)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Wedding Frame</h2> 
            <br>
            <h4> Preserve your wedding memories with our "forever love" wedding frame. Engraved picture frame with a luxurious finish.<br> Beautifully crafted with attention to detail.</p>
            <br><br>
        Size:A4<br> Material:Wood <br> Suitable for:Anniversary,wedding,valentines day <br> Speciality:Easy to hang or display</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_frame1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Wedding Frame</span>
            <a href="">White pastel themed wedding frame</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_frame2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Wedding Frame</span>
            <a href="">Mini frame with heart crafted within</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_frame3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Wedding Frame</span>
            <a href="">Anniversary themed frame</a>
            <h4>Rs.599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed_frame4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Wedding Frame</span>
            <a href="">White floral themed frame</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/wed frame.jpeg"; // Replace this with the actual image path or dynamically fetch it
