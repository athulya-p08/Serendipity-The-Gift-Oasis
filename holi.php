    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/holi colors.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Holi Colors</h4></span>
          <h1>Seven Rangoli Colors</h1>
          <div class="price">Rs.199</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Seven Rangoli Colors',199,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Seven Rangoli Colors',199)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Holi Colors</h2> 
            <br>
            <h4>Add a pop of color to your rangoli designs with our vibrant rangoli powder. Made from high-quality, non-toxic materials. This powder is perfect for creating intricate and beautiful designs.</p>
            <br><br>
        Material:Non-toxic,eco-friendly colors <br> Weight:100gm per pack <br> Care instructions:Store in dry place,Avoid disposing in waterways,Use on a clean surface.<br> Speciality:Non-toxic ingredients,Blendable colors,Eco-friendly </h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/holi_colors1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Holi Colors</span>
            <a href="">Shimmering Splendor</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/holi_colors2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Holi Colors</span>
            <a href="">Festive Frenzy</a>
            <h4>Rs.599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/holi_colors3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Holi Colors</span>
            <a href="">Rangoli Rush</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/holi_colors4.jpeg" alt="" />
            </a>
       
          </div>
          <div class="product-info">
            <span>Holi Colors</span>
            <a href="">Vibrant Vibes</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/holi colors.jpeg"; // Replace this with the actual image path or dynamically fetch it
