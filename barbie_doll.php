    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/barbie doll.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Barbie Doll</h4></span>
          <h1>Pink Barbie Doll</h1>
          <div class="price">Rs.599</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Pink Barbie Doll',599,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Pink Barbie Doll',599)">Add to Wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Barbie Doll</h2> 
            <br>
            <h4> Unleash imagination and self-expression with our barbie fashonista doll.<br> This stylish and creative toy encourages kids to explore their creativity and individuality</p>
            <br><br>
        Height:12 inch<br> Material:High quality plastic <br> Suitable for:3-10 yrs <br> Speciality:Along with accessories and outfits</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>Barbie Doll</span>
            <a href="">Barbie Princess School Set</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>Barbie Doll</span>
            <a href="">Snow-white Princess Set</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/barbie doll.jpeg"; // Replace this with the actual image path or dynamically fetch it
