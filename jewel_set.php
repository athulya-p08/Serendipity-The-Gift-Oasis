    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/jewel set.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Jewel Set</h4></span>
          <h1>Red-White Diamond Set</h1>
          <div class="price">Rs.5999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Red-White Diamond Set',5999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Red-White Diamond Set',5999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Jewel Set</h2> 
            <br>
            <h4>Elevate your style with our stunning jewellery set, expertly crafted to make you shine. This luxurious jewellery set is adorned with brilliant gemstone, carefully selected for their exceptional quality and fire.</p>
            <br><br>
        Material:Diamond, Red emerald <br> Suitable for:weddings, anniversaries, birthdays, formal events <br> Care instructions:Avoid exposure to harsh chemicals,clean the jewellery with soft cloth <br> Speciality:Expertly crafted by skilled artisans</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/jewelset1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Jewel Set</span>
            <a href="">Pink emerald diamond jewel set</a>
            <h4>Rs.6499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/jewelset2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Jewel Set</span>
            <a href="">Green emerald jewel set</a>
            <h4>Rs.7599</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/jewelset3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Jewel Set</span>
            <a href="">Pink stone jewel set</a>
            <h4>Rs.5399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/jewelset4.jpeg" alt="" />
            </a>
          
          </div>
          <div class="product-info">
            <span>Jewel Set</span>
            <a href="">Yellow-white jewel set</a>
            <h4>Rs.4499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/jewel set.jpeg"; // Replace this with the actual image path or dynamically fetch it
