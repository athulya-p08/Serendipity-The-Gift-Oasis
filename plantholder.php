    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/plantholder.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Plantholder</h4></span>
          <h1>Happy Face Plant Holder</h1>
          <div class="price">Rs.499</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Happy Face Plant Holder',499,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Happy Face Plant Holder',499)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Plantholder</h2> 
            <br>
            <h4>Breathe new life into your space with our plant holder. This holder is perfect for indoor,gardens and herbs. It's minimalistic design and durable construction make it perfect for showcasing your favorite plants.</p>
            <br><br>
        Material:White-colored Ceramic<br> Suitable for:Indoor plants,Green-houses,Balcony <br> Pot Size:Accomodates small to medium size plants <br> Speciality:Space-saving design,weather-resistant material,rotating or spinning feature</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/plantholder1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Plantholder</span>
            <a href="">Finley's Plantholder</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/plantholder2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Plantholder</span>
            <a href="">Whale-watcher</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/plantholder3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Plantholder</span>
            <a href="">Tiny The Turtle</a>
            <h4>Rs.399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/plantholder4.jpeg" alt="" />
            </a>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/plantholder.jpeg"; // Replace this with the actual image path or dynamically fetch it
