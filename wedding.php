...
<html lang="en">
  <head>
    ...
    <title>Wedding/Anniversary Category</title>
  </head>
...
<?php
    ...
    <section class="section all-products" id="products">
      ...
      <div class="product-center container">
        <div class="product-item" data-price="1999" data-name="Gold Plated Rings" onclick="document.location='wed_ring.php'">
          <div class="overlay">
          ...
          <div class="product-info">
            <span>RINGS</span>
            <a href="productDetails.html">Gold Plated Rings</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item" data-price="899" data-name="Black-Gold Combo Gift Set" onclick="document.location='wed_watch.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple gift.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>WATCH & BRACELET</span>
            <a href="">Black-Gold Combo Gift Set</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="699" data-name="Black-White Bottle Set" onclick="document.location='couple_bottle.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
          ...
          <div class="product-info">
            <span>Mr. & Mrs. Bottle Set</span>
            <a href="">Black-White Bottle Set</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-center container">
        <div class="product-item" data-price="299" data-name="White Wedding Frame" onclick="document.location='wed_frame.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed frame.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>WEDDING FRAME</span>
            <a href="">White Wedding Frame</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="499" data-name="Cute Mini Showpiece" onclick="document.location='wed_showpiece.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/wed showpiece.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>COUPLE SHOWPIECE</span>
            <a href="">Cute mini showpiece</a>
            <h4>Rs.499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item" data-price="1999" data-name="Crystal Couple Pendant" onclick="document.location='wed_pendant.php'">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/couple pendant.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>COUPLE PENDANT</span>
            <a href="">Crystal Couple Pendant</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
