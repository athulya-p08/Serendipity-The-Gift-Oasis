    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Teddy.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Soft Toys</h4></span>
          <h1>Adorable Teddy</h1>
          <div class="price">Rs.699</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Adorable Teddy',699,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Adorable Teddy',699)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Soft Toys</h2> 
            <br>
            <h4> Wrap your loved ones in warmth and affection with our adorable soft and cuddly teddy bear.<br> Made from ultra-soft plush, this endearing companion is perfect for snuggling and gifting.</p>
            <br><br>
        Fill-material:Soft polyester fibrefill<br> Material:Plush <br> Suitable for:children,adults and seniors <br> Speciality:High quality plush material,ultra-soft</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/teddy1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Soft Toys</span>
            <a href="">Snitch themed soft toy</a>
            <h4>Rs.799</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/teddy2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Soft Toys</span>
            <a href="">Panda themed teddy</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/teddy3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Soft Toys</span>
            <a href="">Pink bunny themed teddy</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/teddy4.jpeg" alt="" />
            </a>
      
          </div>
          <div class="product-info">
            <span>Soft Toys</span>
            <a href="">Green crochet soft toy</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Teddy.jpeg"; // Replace this with the actual image path or dynamically fetch it
