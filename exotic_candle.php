    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Candle.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Candle</h4></span>
          <h1>Exotic Candle</h1>
          <div class="price">Rs.399</div>
          
          <form class="form">
            <a class="cart button" onclick="addToCart('Exotic Candle',399,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Exotic Candle',399)">Add to wishlist</a>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Candle.jpeg"; // Replace this with the actual image path or dynamically fetch it
