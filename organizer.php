    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/table.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Organizer</h4></span>
          <h1>Organizer Table</h1>
          <div class="price">Rs.3999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Organizer Table',3999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Organizer Table',3999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Organizer</h2> 
            <br>
            <h4> Elevate your home with our stylish and multi-functional Organizer table. Perfect for entryways, living rooms or home offices, this versatile table keeps your essentials organized and within reach.</p>
            <br><br>
        Material:High-quality wood,Durable and water-resistant finish <br> Suitable for:Entryways,living rooms,Hallways,Home offices <br> Care instructions:Clean spills to prevent damage, Avoid exposing to direct sunlight <br> Speciality:Multi-functional design with multiple compartments, Perfect for small spaces, Stylish and modern aesthetic </h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/table1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Organizer</span>
            <a href="">FurEver Table</a>
            <h4>Rs.3499</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/table2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Organizer</span>
            <a href="">Storage savvy Table </a>
            <h4>Rs.4999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/table3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Organizer</span>
            <a href="">Multi-Tasker Table</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/table4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Organizer</span>
            <a href="">Functional Furniture</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/table.jpeg"; // Replace this with the actual image path or dynamically fetch it
