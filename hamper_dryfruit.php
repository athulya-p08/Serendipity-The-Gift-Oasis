...
<html lang="en">
  <head>
    ...
    <title>Dry Fruit's Hamper</title>
  </head>
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/dryfruit hamper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Dry Fruit's Hamper</h4></span>
          <h1>Hula Delights Dry Fruit Platter</h1>
          <div class="price">Rs.999</div>
         
          <form class="form">
            <a class="cart button" onclick="addToCart('Hula Delights Dry Fruit Platter',999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Hula Delights Dry Fruit Platter',999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Dry Fruit's Hamper</h2> 
            <br>
            <h4>Indulge in the richness of our dry fruit hamper, featuring an assortment of luscious dry fruits, carefully chosen for their exceptional quality and flavor. This thoughtfully curated selection of dry fruits is the perfect way to show loved ones you care.</p>
            <br><br>
        Hamper size:Medium<br> Suitable for:Festivals,Get well soon <br> Products included:Almonds,Cashews,Pistachios,Walnuts,Dates <br> Weight:1Kg</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dryfruit_hamper1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Dry Fruit's Hamper</span>
            <a href="">Dry Fruit Basket</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dryfruit_hamper2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Dry Fruit's Hamper</span>
            <a href="">Dry Fruit Fiesta</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dryfruit_hamper3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Dry Fruit's Hamper</span>
            <a href="">Dry Fruit Medley</a>
            <h4>Rs.1399</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/dryfruit_hamper4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Dry Fruit's Hamper</span>
            <a href="">Dry Fruit Bonanza</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/dryfruit hamper.jpeg"; // Replace this with the actual image path or dynamically fetch it
