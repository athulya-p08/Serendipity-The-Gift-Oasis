    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/white_bag.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Handbag</h4></span>
          <h1>White Handbag with Golden Chain</h1>
          <div class="price">Rs.999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('White Handbag with Golden Chain',999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('White Handbag with Golden Chain',999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Handbag</h2> 
            <br>
            <h4>Add a touch of elegance to your daily routine with our handbag made from high-quality durable material. It has spacious interior and multiple pockets, provide ample storafe for all your essentials while its stylish design ensures you will look and feel great.</p>
            <br><br>
        Material:High-quality durable leather<br> Suitable for:Working professionals, students, for stylish purpose<br> Care instructions:Wipe clean with damp cloth, avoid exposure to direct sunlight<br> Speciality:Comfortable shoulder strap, multiple interior, elegant design</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/handbag1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Handbag</span>
            <a href="">Baby-pink handbag</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/handbag2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Handbag</span>
            <a href="">Party themed handbag</a>
            <h4>Rs.1499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/handbag3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Handbag</span>
            <a href="">White-pink handbag</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/handbag4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Handbag</span>
            <a href="">White-blue starry handbag</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/white_bag.jpeg"; // Replace this with the actual image path or dynamically fetch it
