    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/self care set.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Self Care Product</h4></span>
          <h1>Unisex Skin Care Set</h1>
          <div class="price">Rs.1999</div>
         
          <form class="form">
            <a class="cart button" onclick="addToCart('Unisex Skin Care Set',1999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Unisex Skin Care Set',1999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Self Care Product</h2> 
            <br>
            <h4>Indulge in the ultimate self-care experience with our self-care set. This carefully curated collection of products is designed to help you relax, rejuvenate and rediscover your inner calm.</p>
            <br><br>
        High quality product:NAtural ingredients that are designed for relaxationa and well-being<br> Suitable for:Busy professionals, Anyone looking for a self-care routine.<br> Benefits:Reduce stress and anxiety, Promotes better sleep, Nourishes and hydrates skin<br> Products:Facial cream, Essential oils, Body butter, Toner</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfcareset1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Care Product</span>
            <a href="">Skin nourishing self-care set</a>
            <h4>Rs.3999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfcareset2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Self Care Product</span>
            <a href="">Snns self-care set</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfcareset3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Care Product</span>
            <a href="">Japan Sakura self-care set</a>
            <h4>Rs.6499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfcareset4.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Self Care Product</span>
            <a href="">&honey self-care set</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/self care set.jpeg"; // Replace this with the actual image path or dynamically fetch it
