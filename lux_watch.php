    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Watch.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Luxury Watch</h4></span>
          <h1>Couple's Watch</h1>
          <div class="price">Rs.19999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Couple Watch',19999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Couple Watch',19999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Luxury Watch</h2> 
            <br>
            <h4>Experience the epitome of luxury and sophistication with our Rolex watch, a timeless and elegant timepiece crafted to perfection. This exquisite watch is designed to make a statement with its sleek design, precise movement and exceptional craftsmanship.</p>
            <br><br>
        Material:White dial,silver-gold strap <br> Suitable for:Business professionals,Formal events <br> Care instructions:Handle the watch with care to avoid scratches or damage <br> Speciality:Waterproof,White dial with slender hands</h4>
      ...
      <div class="product-center container">
        <div class="product-item">
          ...
          <div class="product-info">
            ...
            <a href="">Rolex Daytona "Eye of the Tiger" yellow-gold diamond watch</a>
            <h4>Rs.23999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          ...
          <div class="product-info">
            <span>Luxury Watch</span>
            <a href="">Rolex Cosmograph Daytona Watch</a>
            <h4>Rs.21899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/watch3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Luxury Watch</span>
            <a href="">Rolex Daytona Rosegold Watch</a>
            <h4>Rs.22799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Watch.jpeg"; // Replace this with the actual image path or dynamically fetch it
