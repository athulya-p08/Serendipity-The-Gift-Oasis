    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Slipper.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Soft Slippers</h4></span>
          <h1>Soft Comfy Slippers</h1>
          <div class="price">Rs.899</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Soft Comfy Slippers',899,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Soft Comfy Slippers',899)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Soft Slippers</h2> 
            <br>
            <h4>Wrap your feet in blissful comfort with our cozy steps fluffy soft footwear.<br> Made from ultra-soft,plush materials. These shoes are designed to pamper your feet and keep you feeling relaxed and cozy all day long.</p>
            <br><br>
            Material:Super soft fuzzy<br> Suitable for:lounging around the house <br> Care instructions:machine wash cold,air dry <br> Speciality:lightweight,comfy and flexible outsoles,cushion like comfort</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/slippers1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Soft Slippers</span>
            <a href="">Cute bunny comfy slippers</a>
            <h4>Rs.999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/slippers2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Soft Slippers</span>
            <a href="">Fluffy heart slippers</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/slippers3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Soft Slippers</span>
            <a href="">Cute moo slippers</a>
            <h4>Rs.799</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/slippers4.jpeg" alt="" />
            </a>
         
          </div>
          <div class="product-info">
            <span>Soft Slippers</span>
            <a href="">Fuzzy froggie slippers</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/Slipper.jpeg"; // Replace this with the actual image path or dynamically fetch it
