    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/self help books.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Self Help Books</h4></span>
          <h1>Books - Set of 6</h1>
          <div class="price">Rs.999</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Books - Set of 6',999,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Books - Set of 6',999)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Self Help Books</h2> 
            <br>
            <h4>Discover the secrets to achieve your goals and living a fulfilling life. These books provide advice and strategies for overcoming obstacles, building confidence and unlocking your positive mindset.</p>
            <br><br>
        Genre : Mindfulness, self-care solution, purpose plan<br> Suitable for : Young adults, adults<br> Language : English <br></h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfhelpbook1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Help Books</span>
            <a href="">Signs to grow up (Ciara Daly)</a>
            <h4>Rs.599</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfhelpbook2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Self Help Books</span>
            <a href="">HEAL.GROW.LOVE. (Pieare Alex Jeanty)</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfhelpbook3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Self Help Books</span>
            <a href="">JAR OF MEMORIES (R.Khoirotun)</a>
            <h4>Rs.699</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/selfhelpbook4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Self Help Books</span>
            <a href="">Dear Universe (Sarah Prout)</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
 function addToCart(name, price, quantity) {
    const image = "./images/self help books.jpeg"; // Replace this with the actual image path or dynamically fetch it
