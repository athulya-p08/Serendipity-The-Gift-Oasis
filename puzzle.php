    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/mini puzzle.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Puzzle</h4></span>
          <h1>Inside Out Themed Puzzle</h1>
          <div class="price">Rs.199</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Inside Out Themed Puzzle',199,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Inside Out Themed Puzzle',199)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Puzzle</h2> 
            <br>
            <h4> Unlock your child's cognitive potential with brain booster puzzle set.<br> This engaging and educational puzzle is designed to develop problem solving skills,hand-eye coordination and critical thinking.</p>
            <br><br>
        Size:A4<br> Material:Paper board <br> Suitable for:4-12 yrs <br> Speciality:Durable and long-lasting construction</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/puzzle1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Puzzle</span>
            <a href="">Jurassic themed puzzle</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/puzzle2.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Puzzle</span>
            <a href="">Masha and the bear themed puzzle</a>
            <h4>Rs.299</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/puzzle3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Puzzle</span>
            <a href="">Cute Dog puzzle</a>
            <h4>Rs.199</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/puzzle4.jpeg" alt="" />
            </a>
           
          </div>
          <div class="product-info">
            <span>Puzzle</span>
            <a href="">Beauty and the beast themed puzzle</a>
            <h4>Rs.2499</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/mini puzzle.jpeg"; // Replace this with the actual image path or dynamically fetch it
