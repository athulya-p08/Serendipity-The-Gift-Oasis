    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/heels.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Heels</h4></span>
          <h1>Black-Silver Pencil Heels</h1>
          <div class="price">Rs.1799</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Black-Silver Pencil Heels',1799,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Black-Silver Pencil Heels',1799)">Add to wishlist</a>
          <h3>Product Detail</h3>
          <p>
            <h2>Heels</h2> 
            <br>
            <h4>Elevate your style with our classic black heels. These heels are perfect for any occassion. The sleek design and comfortable fit make them a must have in every women's wardrobe.</p>
            <br><br>
        Material:<br> Suitable for:lounging around the house <br> Care instructions:machine wash cold,air dry <br> Speciality:lightweight,comfy and flexible outsoles,cushion like comfort</h4>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/heels1.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Heels</span>
            <a href="">Butterfly themed heels</a>
            <h4>Rs.1999</h4>
          </div>
          <ul class="icons">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/heels2.jpeg" alt="" />
            </a>
            
          </div>
          <div class="product-info">
            <span>Heels</span>
            <a href="">Floral themed heels</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/heels3.jpeg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>Heels</span>
            <a href="">Purple glass heels</a>
            <h4>Rs.2999</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/heels4.jpeg" alt="" />
            </a>
          
          </div>
          <div class="product-info">
            <span>Heels</span>
            <a href="">Lamps and Ivy Designs Heels</a>
            <h4>Rs.899</h4>
          </div>
          <ul class="icons">
            <li><i class="bx bx-heart"></i></li>
...
<script>
  function addToCart(name, price, quantity) {
    const image = "./images/heels.jpeg"; // Replace this with the actual image path or dynamically fetch it
