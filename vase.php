    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/Vase.jpeg" id="zoom" alt="" />
          </div>
        </div>
        <div class="right">
          <span><h4>Vase</h4></span>
          <h1>Mini Flower Vase</h1>
          <div class="price">Rs.499</div>

          <form class="form">
            <a class="cart button" onclick="addToCart('Mini Flower Vase',499,document.getElementById('quantity').value)">Add To Cart</a>

            <a class="button wishlist-btn" onclick="addToWishlist('Mini Flower Vase',499)">Add to wishlist</a>
...
<script>
 function addToCart(name, price, quantity) {
    const image = "./images/Vase.jpeg"; // Replace this with the actual image path or dynamically fetch it
